...
Application::Application()
{
	...
	modules[9] =    helicopter =    new ModuleHelicopter(false);
	...
	modules[13] =   sceneLayer2 =   new SceneLayer2(false);
	modules[14] =   sceneOver =     new SceneGameOver(false);
	...
	modules[18] =	pickUps =		new ModulePickUps(true);
